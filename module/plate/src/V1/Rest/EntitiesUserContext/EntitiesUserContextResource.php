...
class EntitiesUserContextResource extends DataRetrievingResource
{

    protected $entitiesUserContextService;

    public function __construct(EntitiesUserContextService $entitiesUserContextService, TableGatewayMapper $tableGatewayMapper)
    {
        parent::__construct($tableGatewayMapper);
        $this->setEntitiesUserContextService($entitiesUserContextService);
    }
    ...
    /**
     * @param mixed $entitiesUserContextService
     */
